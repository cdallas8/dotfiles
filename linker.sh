...
ln -sf "${dotfiles}/zellij" "${config}"                                                 && echo "Linked ${BIYELLOW}=>${NC} ${BBLUE}zellij${NC} directory"

if [[ ! -d "${home}/.julia/config" ]]; then mkdir "${home}/.julia/config"; fi  && echo "Directory created ${BIYELLOW}=>${NC} ${BGREEN}julia${NC}"
ln -sf "${dotfiles}/julia/startup.jl" "${home}/.julia/config/"                          && echo "Linked ${BIYELLOW}=>${NC} ${BBLUE}julia${NC} startup"

ln -sf "${dotfiles}/broot/conf.toml" "${config}/broot"                                    && echo "Linked ${BIYELLOW}=>${NC} ${BBLUE}broot${NC} config"
